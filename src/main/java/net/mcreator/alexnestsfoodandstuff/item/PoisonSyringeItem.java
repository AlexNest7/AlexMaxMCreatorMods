...
import net.mcreator.alexnestsfoodandstuff.procedures.PoisonSyringeUsedOnEntityProcedure;
...
public class PoisonSyringeItem extends FoodandstuffModModElements.ModElement {
	@ObjectHolder("foodandstuff_mod:poison_syringe")
	public static final Item block = null;
	public PoisonSyringeItem(FoodandstuffModModElements instance) {
		super(instance, 89);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("poison_syringe");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Let's do it sneaky , shall we?"));
		}
		...
		public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
			...
			World world = entity.world;
			{
				...
				PoisonSyringeUsedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
