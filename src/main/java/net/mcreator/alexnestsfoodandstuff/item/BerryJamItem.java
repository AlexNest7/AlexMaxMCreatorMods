...
import net.mcreator.alexnestsfoodandstuff.procedures.BerryJamLivingSmthIsHitWithProcedure;
import net.mcreator.alexnestsfoodandstuff.procedures.BerryJamFoodEatenProcedure;
...
public class BerryJamItem extends FoodandstuffModModElements.ModElement {
	@ObjectHolder("foodandstuff_mod:berry_jam")
	public static final Item block = null;
	public BerryJamItem(FoodandstuffModModElements instance) {
		super(instance, 1);
	}
