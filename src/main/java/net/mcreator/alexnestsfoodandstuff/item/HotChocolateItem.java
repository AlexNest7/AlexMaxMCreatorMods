...
import net.mcreator.alexnestsfoodandstuff.procedures.HotChocoFoodEatenProcedure;
...
public class HotChocolateItem extends FoodandstuffModModElements.ModElement {
	@ObjectHolder("foodandstuff_mod:hot_chocolate")
	public static final Item block = null;
	public HotChocolateItem(FoodandstuffModModElements instance) {
		super(instance, 4);
	}
