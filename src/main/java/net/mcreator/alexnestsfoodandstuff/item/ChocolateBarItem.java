...
public class ChocolateBarItem extends FoodandstuffModModElements.ModElement {
	@ObjectHolder("foodandstuff_mod:chocolate_bar")
	public static final Item block = null;
	public ChocolateBarItem(FoodandstuffModModElements instance) {
		super(instance, 6);
	}
