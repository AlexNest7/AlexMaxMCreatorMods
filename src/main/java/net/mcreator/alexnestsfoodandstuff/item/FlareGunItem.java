...
public class FlareGunItem extends FoodandstuffModModElements.ModElement {
	@ObjectHolder("foodandstuff_mod:flare_gun")
	...
	public FlareGunItem(FoodandstuffModModElements instance) {
		super(instance, 59);
