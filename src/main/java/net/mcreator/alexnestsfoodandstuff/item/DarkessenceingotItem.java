...
public class DarkessenceingotItem extends FoodandstuffModModElements.ModElement {
	@ObjectHolder("foodandstuff_mod:darkessenceingot")
	public static final Item block = null;
	public DarkessenceingotItem(FoodandstuffModModElements instance) {
		super(instance, 49);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(AMFaSItemsItemGroup.tab).maxStackSize(64).isImmuneToFire().rarity(Rarity.UNCOMMON));
