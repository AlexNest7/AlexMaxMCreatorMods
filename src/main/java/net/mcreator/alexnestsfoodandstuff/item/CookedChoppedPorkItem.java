...
import net.mcreator.alexnestsfoodandstuff.procedures.CookedPorkchopFoodEatenProcedure;
...
public class CookedChoppedPorkItem extends FoodandstuffModModElements.ModElement {
	@ObjectHolder("foodandstuff_mod:cooked_chopped_pork")
	public static final Item block = null;
	public CookedChoppedPorkItem(FoodandstuffModModElements instance) {
		super(instance, 12);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(AMFoodModItemGroup.tab).maxStackSize(64).rarity(Rarity.UNCOMMON)
					.food((new Food.Builder()).hunger(13).saturation(1.1f).meat().build()));
