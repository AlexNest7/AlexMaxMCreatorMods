...
public class FlaregunAmmoItem extends FoodandstuffModModElements.ModElement {
	@ObjectHolder("foodandstuff_mod:flaregun_ammo")
	public static final Item block = null;
	public FlaregunAmmoItem(FoodandstuffModModElements instance) {
		super(instance, 59);
	}
