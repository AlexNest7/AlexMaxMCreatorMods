...
public class DarkEssenceFoodEatenProcedure extends FoodandstuffModModElements.ModElement {
	public DarkEssenceFoodEatenProcedure(FoodandstuffModModElements instance) {
		super(instance, 43);
	}
