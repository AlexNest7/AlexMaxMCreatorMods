...
import net.mcreator.alexnestsfoodmod.procedures.DarkEssenceFoodEatenProcedure;
...
public class DarkEssenceItem extends FoodModModElements.ModElement {
	@ObjectHolder("food_mod:dark_essence")
	public static final Item block = null;
	public DarkEssenceItem(FoodModModElements instance) {
		super(instance, 41);
	}
